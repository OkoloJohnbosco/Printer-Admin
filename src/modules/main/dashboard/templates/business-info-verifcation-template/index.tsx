...
import SucessfulVerification from "./sucessfull-verification";
...
export default function BusinessInfoVerificationFormModal({
  ...
  return (
    <AlertDialog open={isOpen}>
      <AlertDialogContent className="w-full bg-brand-gray-500 max-h-[88vh] pb-0 overflow-auto pt-0 scroll-smooth space-y-4 border-0 px-0 shadow-none sm:max-w-2xl">
        ...
        <BusinessInfoVerificationForm onClose={onClose} />
